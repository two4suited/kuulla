...
struct ShowSettings: Codable, Hashable {
    ...
    init(
        ...
        smartSpeed: Bool? = nil, voiceBoost: Bool? = nil, autoAddNewEpisodesToUpNext: Bool? = nil,
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case autoDownloadNewEpisodes, autoDeleteRule, autoDeleteAfterDays, smartSpeed, voiceBoost, autoAddNewEpisodesToUpNext
