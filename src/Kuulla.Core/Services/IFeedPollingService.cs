...
// did. A single method (rather than folded directly into the hosted service below) so the actual
// polling logic can be unit tested without standing up a BackgroundService's timer loop.
